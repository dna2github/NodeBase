...
class _NodeBaseAppItemState extends State<NodeBaseAppItem> {
  ...
  Widget build(BuildContext context) {
    if (widget.isEdit) {
      ...
      final entities = <Widget>[
        ...
        ListTile(
            ...
            title: TextField(
                ...
                decoration: InputDecoration(labelText: 'Platform'))) // ListTile
      ];
      ...
      return Card(child: Column(children: entities));
    }
        ...
        child: ListTile(
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          NodeBaseAppHome(item: widget.item)));
            }));
  }
}
...
class _NodeBaseApplicationsState extends State<NodeBaseApplications> {
  ...
  makeItem(NodeBaseApp item) {
    return NodeBaseAppItem(
        item: item, fnRemove: removeItem, fnSaveConfig: saveConfig);
  }
